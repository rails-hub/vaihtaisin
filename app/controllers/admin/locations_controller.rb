class Admin::LocationsController < ApplicationController
  ...
  def location_params
    params.require(:location).permit(:name, :area1, :area2, :caretype, :streetaddress, :streetnumber, :pobox, :zipcode, :ziparea, :city, :phone, :email, :supervisor, :supervisoremail, :supervisorphone, :capacity, :lat, :lng)
  end
